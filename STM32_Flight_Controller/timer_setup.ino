...
void timer_setup(void) {
  ...
  Timer3.attachCompare1Interrupt(Serial_input_handler);
  TIMER3_BASE->CR1 = TIMER_CR1_CEN;
  TIMER3_BASE->CR2 = 0;
  TIMER3_BASE->SMCR = 0;
  TIMER3_BASE->DIER = TIMER_DIER_CC1IE;
  TIMER3_BASE->EGR = 0;
  TIMER3_BASE->CCMR1 = TIMER_CCMR1_CC1S_INPUT_TI1; //A6 is serial input.
  TIMER3_BASE->CCMR2 = 0;
  TIMER3_BASE->CCER = TIMER_CCER_CC1E;
  TIMER3_BASE->CCER |= TIMER_CCER_CC1P; //Detect the faling edge.
  TIMER3_BASE->PSC = 71;
